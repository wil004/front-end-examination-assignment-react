...
function Login () {
    ...
    return (
        <main className="login">
            {!loading && <h1>Inloggen</h1>}
            {loading ? <h2>Loading please wait...</h2> : <form className="loginForm">
                <p className="loginInfo">Login to your account to see the newspages!
                ...
                <button disabled={!userName || !password1} onClick={(e) => {handleClick(); preventDefault(e);}}>Inloggen</button>
