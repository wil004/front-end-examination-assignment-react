        ...
        <main className="personalPage">
            {setAccount === 'setImage' ?
                ...
                <ChangeProfile
                    ...
                    currentDetails={<p>Choose your new password below! Fill it in twice and confirm it with your old password!</p>}
        ...
        <section className="personalPageInfo">
            <div className="personalPageContainer">
               <h1 className="personalPageTitle">ProfilePicture</h1>
                    <img src={auth.user.profilePicture ? auth.user.profilePicture : defaultProfilePicture} className="userPageProfilePicture"/>
            ...
            <div className="personalPageInputInfo">
                <button className="personalPageButton" onClick={() => {history.push
                    ('/userPage/setImage')}}>Change Profile picture</button>
                <button className="personalPageButton" onClick={() => {history.push('/userPage/changeEmail')}}>Change email-adress</button>
                <button className="personalPageButton" onClick={() => {history.push('/userPage/changePassword')}}>Change password</button>
            </div>
        </section>}
        </main>
